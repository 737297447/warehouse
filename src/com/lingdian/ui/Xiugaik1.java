 ...
 * 
 */
public class Xiugaik1 extends BaseActivity {
		...
		if (gsmc.getText().toString().equals("")) {
			...
			do {
				...
				if (cname.equals(egsmc)&&pname.equals(elxr)&&padd.equals(elxdz)&&pcity.equals(ecsmc)
						...
						&&pzhen.equals(eczhm)) {
					DialogDemo.builder(Xiugaik1.this, "错误信息", "该顾客信息未做改变，不需要修改");
					cursor.close();
					break;
			...
			if (!(cname.equals(egsmc)&&pname.equals(elxr)&&padd.equals(elxdz)&&pcity.equals(ecsmc)
				...
				finish();
				Xiugaik.instance.finish();
				Intent i = new Intent(Xiugaik1.this,Xiugaik.class);
				startActivity(i);
			}
		}
	}
