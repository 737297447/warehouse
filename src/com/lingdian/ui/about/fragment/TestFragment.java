package com.lingdian.ui.about.fragment;
...
public class TestFragment extends Fragment{
	...
	private TextView about_title_contact;
	private View root;
	private View view;
	...
	private void initUI(final View root) {
		...
		about_title_text = (TextView) root.findViewById(R.id.about_title_text);
		about_title_contact = (TextView) root.findViewById(R.id.about_title_contact);
	...
	public void show(final View view,Bundle bundle){
		...
		about_title_text.setText(text);
		int contact = bundle.getInt("contact");
		about_title_contact.setText(contact);
