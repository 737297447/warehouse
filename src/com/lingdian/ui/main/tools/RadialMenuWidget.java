package com.lingdian.ui.main.tools;
...
import com.lingdian.ui.ChaxunChukuActivity;
import com.lingdian.ui.ChaxunRukuActivity;
import com.lingdian.ui.ChaxunShangpinActivity;
import com.lingdian.ui.ChaxungGysActivity;
import com.lingdian.ui.Shanchuc;
import com.lingdian.ui.Shanchug;
import com.lingdian.ui.Shanchur;
import com.lingdian.ui.Shanchus;
import com.lingdian.ui.TianjiaChukuActivity;
import com.lingdian.ui.TianjiaRukuActivity;
import com.lingdian.ui.Tianjiag;
import com.lingdian.ui.Xiugaic;
import com.lingdian.ui.Xiugaig;
import com.lingdian.ui.Xiugair;
import com.lingdian.ui.Xiugais;
...
public class RadialMenuWidget extends View {
		...
		if (state == MotionEvent.ACTION_DOWN) {
			...
			if (inCircle == true) {
				...
				for (int i = 0; i < Wedges2.length; i++) {
					Wedge f = Wedges2[i];
					if (f == selected2) {
						intentAvtivity(wedge2Data.getChildren().get(i).getName());
	...
	public void intentAvtivity(String getName){

		final Intent intent = new Intent();
		intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);  
		if(getName.equals("11")){
			intent.setClass(getContext(), Tianjiag.class);
		}else if(getName.equals("12")){
			intent.setClass(getContext(), ChaxungGysActivity.class);
		}else if(getName.equals("13")){
			intent.setClass(getContext(), Xiugaig.class);
		}else if(getName.equals("14")){
			intent.setClass(getContext(), Shanchug.class);
		}else if(getName.equals("21")){
			intent.setClass(getContext(), GoodsAddAvtivity.class);
		}else if(getName.equals("22")){
			intent.setClass(getContext(), ChaxunShangpinActivity.class);
		}else if(getName.equals("23")){
			intent.setClass(getContext(), Xiugais.class);
		}else if(getName.equals("24")){
			intent.setClass(getContext(), Shanchus.class);
		}else if(getName.equals("31")){
			intent.setClass(getContext(), TianjiaRukuActivity.class);
		}else if(getName.equals("32")){
			intent.setClass(getContext(), ChaxunRukuActivity.class);
		}else if(getName.equals("33")){
			intent.setClass(getContext(), Xiugair.class);
		}else if(getName.equals("34")){
			intent.setClass(getContext(), Shanchur.class);
		}else if(getName.equals("41")){
			intent.setClass(getContext(), TianjiaChukuActivity.class);
		}else if(getName.equals("42")){
			intent.setClass(getContext(), ChaxunChukuActivity.class);
		}else if(getName.equals("43")){
			intent.setClass(getContext(), Xiugaic.class);
		}else if(getName.equals("44")){
			intent.setClass(getContext(), Shanchuc.class);
		}
