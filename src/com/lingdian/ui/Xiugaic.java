...
public class Xiugaic extends BaseActivity implements android.view.View.OnClickListener{
	...
	public static Xiugaic instance = null;
	@Override
					...
					if(arg2==i){
						...
						builder.setPositiveButton("确定", new OnClickListener() {
							...
							public void onClick(DialogInterface dialog, int which) {
								...
								bundle.putString("shuName",city[j]);
