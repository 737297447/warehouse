...
public class Chaxuns extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SimpleAdapter simple = new SimpleAdapter(this, slist,
				R.layout.goods_select_adapter, new String[] { "did", "dname", "dpass",
						"dnum", "dgongys" }, new int[] { R.id.t1, R.id.t2,
						R.id.t3, R.id.t4, R.id.t5, });
